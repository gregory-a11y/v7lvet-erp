...
function findLabel(options: readonly { value: string; label: string }[], value: string | undefined): string | undefined {
							...
							<AlertDialog>
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											Le client sera archivé et n'apparaîtra plus dans la liste active.
					...
					<TabsContent value="informations" className="mt-6 space-y-6">
						<div className="grid gap-6 md:grid-cols-2">
							...
							<Card>
								...
								<CardContent className="space-y-0">
									<InfoRow label="Catégorie fiscale" value={findLabel(CATEGORIES_FISCALES, client.categorieFiscale)} />
									<InfoRow label="Régime fiscal" value={findLabel(REGIMES_FISCAUX, client.regimeFiscal)} />
									<InfoRow label="Régime TVA" value={findLabel(REGIMES_TVA, client.regimeTVA)} />
									<InfoRow label="Fréquence TVA" value={findLabel(FREQUENCES_TVA, client.frequenceTVA)} />
							...
							{/* Taxes */}
							<Card>
								<CardHeader><CardTitle className="text-base">Taxes & Cotisations</CardTitle></CardHeader>
								<CardContent className="space-y-0">
									<InfoRow label="Montant CFE N-1" value={client.montantCFEN1?.toLocaleString("fr-FR")} />
									<InfoRow label="Montant CVAE N-1" value={client.montantCVAEN1?.toLocaleString("fr-FR")} />
									<InfoRow label="Montant TS N-1" value={client.montantTSN1?.toLocaleString("fr-FR")} />
									...
									<InfoRow label="Surface commerciale" value={client.surfaceCommerciale ? `${client.surfaceCommerciale} m²` : undefined} />
